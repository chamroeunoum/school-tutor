 ...
 * Store Components
 */
import StoreCrud from './components/store/index.vue'
import StoreListCrud from './components/store/list.vue'
import ThumbnailListCrud from './components/store/thumbnail.vue'
import StoreCreateCrud from './components/store/create.vue'
import StoreUpdateCrud from './components/store/update.vue'
/**
 * Error
 */
     ...
     */
    {
         ...
         */
        {
            ...
            children: [
                ...
                //     name: "StoreList" ,
                //     path: '' ,
                //     component: StoreListCrud
                // },
                {
                    name: "StoreThumbnail" ,
                    path: '' ,
                    component: ThumbnailListCrud
                },
                {
                    name: "SToreCreate" ,
                    path: 'create' ,
                    component: StoreCreateCrud
                },
                {
                    name: "StoreUpdate" ,
                    path: 'update' ,
                    component: StoreUpdateCrud
                }
            ]
        },
        /**

    ...
    <div class="vcb-table-panel relative flex items-start flex-wrap ">
        <div v-for="(record, index) in table.records.matched" :key='index' class="relative p-2 m-2 border border-gray-300 shadow rounded w-1/5 pb-10" >
          ...
          <div class="my-2 text-left" >
            DESCRIPTION<n-input class="inline-input" type="textarea" v-model:value="record.description" @blur="inlineUpdate(record)" ></n-input>
          </div>
          <div  class="my-2 text-left" >
            VENDOR UPC<n-input class="inline-input" type="text" v-model:value="record.vendor_upc" placeholder="VENDOR UPC" @blur="inlineUpdate(record)" ></n-input>
          </div>
          <div  class="my-2 text-left" >
            VENDOR SKU<n-input class="inline-input" type="text" v-model:value="record.vendor_sku" placeholder="VENDOR SKU" @blur="inlineUpdate(record)" ></n-input>
          </div>
          <div  class="my-2 text-left" >
            ORIGIN<n-input class="inline-input" type="text" v-model:value="record.origin" @blur="inlineUpdate(record)" ></n-input>
          </div>

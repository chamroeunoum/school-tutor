            ...
            <div class=" mx-auto p-4 flex-wrap">
              <div class="crud-form-panel w-full flex flex-wrap ">
                ...
                >
                  ...
                  <n-form-item label="Vendor SKU" class="w-4/5 mr-8" >
                    <n-input v-model:value="record.vendor_sku" clearable placeholder="Vendor SKU" />
                  </n-form-item>
                  <n-form-item label="Vendor UPC" class="w-4/5 mr-8" >
                    <n-input v-model:value="record.vendor_upc" clearable placeholder="Vendor UPC" />
                  </n-form-item>
      ...
      store.dispatch( props.model.name+'/create',{
        ...
        switch( res.status ){
          case 200 : 
            ...
            record.vendor_sku = res.data.record.vendor_sku
            record.vendor_upc = res.data.record.vendor_upc
            uploadFiles()
            // clearRecord()
          break;
        }

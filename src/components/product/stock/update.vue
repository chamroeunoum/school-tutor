            ...
            <div class=" mx-auto p-4 flex-wrap">
              <div class="crud-form-panel w-full flex flex-wrap ">
                ...
                >
                  ...
                  <n-form-item label="លេខកូដ UPC របស់ផលិតផល" class="w-4/5 mr-8" >
                    <n-input v-model:value="record.upc" clearable placeholder="UPC" />
                  </n-form-item>
                  <n-form-item label="លេខកូន SKU របស់ផលិតផល" class="w-4/5 mr-8" >
                    <n-input v-model:value="record.vendor_sku" clearable placeholder="SKU" />
                  </n-form-item>
                  <n-form-item label="ទីតាំងផលិតផលក្នុងឃ្លាំង" class="w-4/5 mr-8" >
                    <n-input type="textarea" v-model:value="record.location" placeholder="ទិតាំងទុកឥវ៉ាន់ក្នុងឃ្លាំង" />
                  </n-form-item>
  ...
  setup(props){
    ...
    function create(){
      ...
      store.dispatch( props.model.name+'/update',{
        ...
        vendor_sku : props.record.vendor_sku ,
        upc: props.record.upc ,
        variants: variants
      }).then( res => {
        switch( res.status ){
          case 200 : 

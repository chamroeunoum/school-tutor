            ...
            <div class=" mx-auto p-4 flex-wrap">
              <div class="crud-form-panel w-full flex flex-wrap ">
                ...
                >
                  ...
                  <n-form-item label="លេខកូដ SKU" class="w-4/5 mr-8" >
                    <n-input v-model:value="sku" clearable placeholder="SKU" />
                  </n-form-item>
                  <n-form-item label="តម្លៃក្នុង ១ ឯកតា" class="w-4/5 mr-8" >
                    <n-input-number v-model:value="unit_price" clearable placeholder="តម្លៃ" />
                  </n-form-item>
  ...
  setup(props){
    ...
    function create(){
      ...
      if( unit_price.value < 0 ){
        notify.warning({
          'title' : 'ពិនិត្យព័ត៌មាន' ,
          'description' : 'សូមបំពេញ តម្លៃឯកតា' ,
          duration : 3000
        })
        return false
      }

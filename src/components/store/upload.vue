  ...
  <!-- Form edit account -->
    <div class="vcb-pop-create font-ktr">
      <n-modal v-model:show="show" :on-after-leave="onClose" transform-origin="center">
        <n-card class="w-1/2 font-pvh text-xl" :title="record.name" :bordered="false" size="small">
          ...
          <div class="crud-create-form w-full border-t">
            <div class=" mx-auto p-4 flex-wrap">
              ...
              <div class="crud-form-panel w-full flex items-start mb-16">
                <div v-for="(picture, index) in record.images" :key="index" class="relative w-40 p-2 m-2 cursor-pointer border-gray-200 border rounded hover:border-gray-400 hover:shadow-md duration-300" >
                  <img :src="picture" @click="updateFeaturePicture(index)" />
                  <n-icon size="18" class="cursor-pointer text-red-500 -right-3 -top-3 absolute " @click="deletePicture(index)" title="លុបចោល" >
                    <TrashOutline />
                  </n-icon>
                </div>
              </div>
